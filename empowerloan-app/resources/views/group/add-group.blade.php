                ...
                <div class="card-body ">
                    <div class="card-header card-title">
                        <div class="d-flex align-items-center">
                          <h2 class="d-none d-lg-block text-primary">Add Group</h2>
                        </div>
                      </div>
                      @if (count($errors) > 0)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="branch_code" id="br_code" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect2">Loan Officer</label>
                                        <select class="form-control" name="emp_no" id="lo" required>
